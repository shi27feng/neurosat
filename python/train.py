...
parser.add_argument('--n_saves_to_keep', action='store', dest='n_saves_to_keep', type=int, default=4,
...
for epoch in range(opts.n_epochs):
    ...
    epoch, etrain_cost, etrain_mat.ff, etrain_mat.ft, etrain_mat.tf, etrain_mat.tt, etime))
